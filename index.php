        ...
        <div class="conteudo">
            <nav class="modulos">
                <div class="modulo vermelho-escuro">
                    ...
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=funcoes&file=escopo">Funções Escopo</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="exercicio.php?dir=funcoes&file=args_variaveis">Argumentos Variaveis</a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="exercicio.php?dir=funcoes&file=anonimas">Funções Anonimas</a>
                        </li>
                        <li>
                ...
                <div class="modulo verde-escuro">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=repeticoes&file=while">Wile /  Do While</a>
                        </li>
                        <li>
                ...
                <div class="modulo laranja">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=array&file=comparacao">Comparação Array</a>
                        </li>
                    </ul>
                </div>
                <div class="modulo roxo">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=controle&file=operadores_logicos">Operadores Logicos</a>
                        </li>
                        <li>
                            <a href="exercicio.php?dir=controle&file=desafio_operadores_logicos">Desafio Op Logicos</a>
                        </li>
                        <li>
                ...
                <div class="modulo azul">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="exercicio.php?dir=variaveis&file=variaveis_variaveis">Variavéis Variáveis</a>
                            </li>
                            <li>
                                <a href="exercicio.php?dir=variaveis&file=desafio_variaveis">Desafio Variáveis</a>
                            </li>
                            <li>
                                <a href="exercicio.php?dir=variaveis&file=valor_referencia">Valor Referência</a>
                            </li>
                            <li>
                ...
                <div class="modulo vermelho">
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="exercicio.php?dir=tipos&file=float">Tipos Float</a>
                            </li>
                            <li>
                                <a href="exercicio.php?dir=tipos&file=aritmeticas">Aritmeticas</a>
                            </li>
                            <li>
                                <a href="exercicio.php?dir=tipos&file=desafio_precedencia">Desaf Precedencia</a>
                            </li>
                            <li>
                                <a href="exercicio.php?dir=tipos&file=string">Tipo String</a>
                            </li>
                            <li>
                                <a href="exercicio.php?dir=tipos&file=desafio_string">Desaf String</a>
                            </li>
                            <li>
